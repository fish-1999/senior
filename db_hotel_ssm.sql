...
INSERT INTO `checkin` VALUES ('16', '2', '1', '168.00', '张三', '62225225666552', '13656565656', '0', '2019-01-20', '2019-01-22', null, '张三', '2019-01-20 15:36:26');
...
INSERT INTO `checkin` VALUES ('24', '2', '1', '100.00', '张三', '4622987745565656', '13912233333', '1', '2019-06-05', '2019-06-06', '17', '好', '2019-06-06 09:23:31');
INSERT INTO `checkin` VALUES ('25', '3', '11', '300.00', '李胜', '3412223234780', '17615042024', '0', '2019-06-10', '2019-06-11', '18', '你好', '2019-06-10 08:26:32');
INSERT INTO `checkin` VALUES ('26', '3', '10', '100.00', '小明', '31012002522555', '13545455454', '0', '2019-01-21', '2019-01-23', '16', '奢侈一把！1111', '2019-06-10 09:23:46');
INSERT INTO `checkin` VALUES ('27', '9', '12', '222.00', '黎华', '233256654', '17615042024', '0', '2019-06-19', '2019-06-20', '20', '', '2019-06-19 00:40:52');
INSERT INTO `checkin` VALUES ('28', '7', '1', '495.00', 'MAHANG', '12', '17615042024', '0', '2019-06-15', '2019-06-20', '23', '12啊啊啊', '2019-06-19 21:50:56');
INSERT INTO `checkin` VALUES ('29', '10', '2', '598.00', '李生', '343434', '17615042024', '0', '2019-06-19', '2019-06-21', '24', 'HAHHA', '2019-06-19 21:54:51');
INSERT INTO `checkin` VALUES ('30', '11', '1', '792.00', '丽水', '12', '17615042024', '1', '2019-06-19', '2019-06-27', '25', '23131安全网', '2019-06-19 22:08:17');
...
INSERT INTO `log` VALUES ('74', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-06 09:13:54');
INSERT INTO `log` VALUES ('75', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-06 16:03:49');
INSERT INTO `log` VALUES ('76', '用户名为admin的用户登录时输入密码错误!', '2019-06-06 18:46:00');
INSERT INTO `log` VALUES ('77', '用户名为admin的用户登录时输入密码错误!', '2019-06-06 18:46:16');
INSERT INTO `log` VALUES ('78', '用户名为admin的用户登录时输入密码错误!', '2019-06-06 18:46:47');
INSERT INTO `log` VALUES ('79', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-06 18:47:07');
INSERT INTO `log` VALUES ('80', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-10 00:58:29');
INSERT INTO `log` VALUES ('81', '用户名为admin的用户登录时输入密码错误!', '2019-06-10 08:18:26');
INSERT INTO `log` VALUES ('82', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-10 08:18:49');
INSERT INTO `log` VALUES ('83', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-10 08:33:59');
INSERT INTO `log` VALUES ('84', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-10 08:46:48');
INSERT INTO `log` VALUES ('85', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-10 09:17:46');
INSERT INTO `log` VALUES ('86', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-10 09:22:14');
INSERT INTO `log` VALUES ('87', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-18 12:19:19');
INSERT INTO `log` VALUES ('88', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-18 14:29:47');
INSERT INTO `log` VALUES ('89', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-19 00:25:33');
INSERT INTO `log` VALUES ('90', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-19 01:02:48');
INSERT INTO `log` VALUES ('91', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-19 20:10:04');
INSERT INTO `log` VALUES ('92', '用户名为admin的用户登录时输入验证码错误!', '2019-06-19 21:02:04');
INSERT INTO `log` VALUES ('93', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-19 21:02:18');
INSERT INTO `log` VALUES ('94', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-19 21:53:21');
INSERT INTO `log` VALUES ('95', '用户名为admin的用户登录时输入验证码错误!', '2019-06-19 22:01:40');
INSERT INTO `log` VALUES ('96', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-19 22:02:54');
INSERT INTO `log` VALUES ('97', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-06-19 23:41:06');
INSERT INTO `log` VALUES ('98', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-09-11 10:48:47');
INSERT INTO `log` VALUES ('99', '用户名为{admin}，角色为{超级管理员}的用户登录成功!', '2019-09-11 10:54:36');
...
-- Records of room
-- ----------------------------
INSERT INTO `room` VALUES ('2', '/HotelManages/resources/upload/1547560664869.jpg', '1001', '1', '1', '2', '1001单人间、1楼。');
INSERT INTO `room` VALUES ('3', '/HotelManages/resources/upload/1547560745508.jpg', '2001', '2', '2', '1', '2楼普通大床房');
INSERT INTO `room` VALUES ('4', '/HotelManages/resources/upload/1547560846621.jpg', '3001', '3', '3', '2', '3001豪华大床房');
INSERT INTO `room` VALUES ('5', '/HotelManages/resources/upload/1547824761959.jpg', '4001', '4', '4', '0', '商务大床房');
INSERT INTO `room` VALUES ('6', '/HotelManages/resources/upload/1547910499411.jpg', '5001', '6', '5', '2', '豪华标准房');
INSERT INTO `room` VALUES ('7', '/HotelSSM/resources/admin/easyui/images/user_photo.jpg', '6001', '1', '1', '1', '精品单人间');
INSERT INTO `room` VALUES ('8', '/HotelSSM/resources/admin/easyui/images/user_photo.jpg', '7001', '1', '1', '0', '新增');
INSERT INTO `room` VALUES ('9', '/HotelSSM/resources/admin/easyui/images/user_photo.jpg', '8001', '12', '1', '1', '新增');
INSERT INTO `room` VALUES ('10', '/HotelSSM/resources/admin/easyui/images/user_photo.jpg', '9001', '2', '1', '1', '');
INSERT INTO `room` VALUES ('11', '/HotelSSM/resources/admin/easyui/images/user_photo.jpg', '1010', '1', '1', '2', '');
...
-- ----------------------------
INSERT INTO `room_type` VALUES ('1', '单人间', '/HotelManages/resources/upload/1547863202049.jpg', '99.00', '1', '1', '12', '4', '7', '2', '1', '单人间只能入住一个人，大概15平米左右！');
INSERT INTO `room_type` VALUES ('2', '普通大床房', '/HotelManages/resources/upload/1547863299550.jpg', '299.00', '2', '1', '15', '13', '2', '1', '1', '普通大床房，面积25平左右！');
INSERT INTO `room_type` VALUES ('3', '豪华大床房', '/HotelManages/resources/upload/1547863308339.jpg', '399.00', '2', '1', '8', '8', '0', '0', '1', '豪华大床房，面积30平左右！');
INSERT INTO `room_type` VALUES ('4', '商务大床房', '/HotelManages/resources/upload/1547865202071.jpg', '429.00', '2', '1', '10', '10', '0', '0', '1', '商务大床房，面积40平左右！');
INSERT INTO `room_type` VALUES ('5', '普通标准间', '/HotelManages/resources/upload/1547863370413.jpg', '199.00', '2', '2', '11', '11', '0', '0', '1', '普通标准房，面积20平左右！');
INSERT INTO `room_type` VALUES ('6', '豪华标准房', '/HotelManages/resources/upload/1547863398297.jpg', '199.00', '2', '2', '10', '10', '0', '0', '1', '豪华标准房，面积30平左右！');
INSERT INTO `room_type` VALUES ('7', '商务标准间', '/HotelManages/resources/upload/1547863458969.jpg', '299.00', '2', '2', '10', '10', '0', '0', '1', '商务标准间，面积35平左右！');
INSERT INTO `room_type` VALUES ('8', '普通套房', '/HotelManages/resources/upload/1547863486075.jpg', '699.00', '2', '2', '6', '6', '0', '0', '1', '普通套房，面积50平左右！');
INSERT INTO `room_type` VALUES ('9', '豪华套房', '/HotelManages/resources/upload/1547863508790.jpg', '899.00', '2', '2', '5', '5', '0', '0', '1', '豪华套房，面积70平左右！');
INSERT INTO `room_type` VALUES ('10', '总统套房', '/HotelManages/resources/upload/1547863538884.jpg', '1299.00', '2', '2', '3', '2', '1', '1', '1', '总统套房，面积100平，超豪华！');
INSERT INTO `room_type` VALUES ('11', '精品套房', '/HotelManages/resources/upload/1547863538884.jpg', '300.00', '2', '2', '5', '4', '1', '1', '1', '总统套房，面积100平，超豪华！');
INSERT INTO `room_type` VALUES ('12', '经济房', '/HotelSSM/resources/admin/easyui/images/user_photo.jpg', '59.00', '1', '1', '1', '0', '1', '1', '0', '新增');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'admin', '1', '/HotelManages/resources/upload/1547287973818.png', '1', '1', '河南郑州');
INSERT INTO `user` VALUES ('13', 'xia', '123456', '2', '/HotelManages/resources/upload/1547288014056.jpg', '1', '1', '大连');
