...
<!-- 						相差天数:   <input id="day" /> -->
                    ...
                    <div class="info_group">
                        <label>房费总计</label><span id="total" class="total">￥${roomType.price }</span>
                ...
                <li>
                    <div class="msg">
                    <c:if test="${roomType.price<100 }">
                        预定须知:请携带好本人的身份证，办理入住手续，本店办理入住需要在前台缴费押金 ￥ <span id="yajin">100</span>
                        </c:if>
                        <c:if test="${roomType.price>100 }">
                           预定须知:请携带好本人的身份证，办理入住手续，本店办理入住需要在前台缴费押金 ￥<span id="yajin">200</span>
</c:if>
                    </div>
